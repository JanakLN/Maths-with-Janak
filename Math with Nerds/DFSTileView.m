...
- (void)drawRect:(CGRect)rect
{
	...
	CGContextSetLineWidth(context, 3.0);
		...
		[[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:.75] setFill];
	...
	CGContextDrawPath(context, kCGPathFillStroke);
		...
		CGRect tr3 = CGRectMake(rect.origin.x + rect.size.width - 17, rect.origin.y + rect.size.height - 17, 15, 15);
