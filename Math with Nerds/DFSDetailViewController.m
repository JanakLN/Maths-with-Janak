...
- (void)configureView
{
	...
	if (self.game) {
        ...
        DFSPlayer *currentUser = self.game.player1.gameCenterID == [[GKLocalPlayer localPlayer] playerID] ? self.game.player1 : self.game.player2;
		self.tileView1.tile = currentUser.tileSet.count > 0 ? currentUser.tileSet[0] : nil;
		self.tileView2.tile = currentUser.tileSet.count > 1 ? currentUser.tileSet[1] : nil;
		self.tileView3.tile = currentUser.tileSet.count > 2 ? currentUser.tileSet[2] : nil;
		self.tileView4.tile = currentUser.tileSet.count > 3 ? currentUser.tileSet[3] : nil;
		self.tileView5.tile = currentUser.tileSet.count > 4 ? currentUser.tileSet[4] : nil;
		self.tileView6.tile = currentUser.tileSet.count > 5 ? currentUser.tileSet[5] : nil;
		self.tileView7.tile = currentUser.tileSet.count > 6 ? currentUser.tileSet[6] : nil;
		self.tileView8.tile = currentUser.tileSet.count > 7 ? currentUser.tileSet[7] : nil;
		self.tileView9.tile = currentUser.tileSet.count > 8 ? currentUser.tileSet[8] : nil;
		self.tileView10.tile = currentUser.tileSet.count > 9 ? currentUser.tileSet[9] : nil;
